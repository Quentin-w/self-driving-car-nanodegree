...
int main() {
	...
	// TODO: Initialize the pid variable with value from class.
	double init_Kp = 0.13;
				...
				if (length && length > 2 && data[0] == '4' && data[1] == '2')
				{
					...
					if (s != "") {
						...
						if (event == "telemetry") {
							...
							steer_value = - steer_pid.Kp * steer_pid.p_error
							- steer_pid.Kd * steer_pid.d_error
							- steer_pid.Ki * steer_pid.i_error;
