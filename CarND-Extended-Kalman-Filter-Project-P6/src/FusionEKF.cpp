...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
	 ...
	 */
	//delta t between the current and previous measurements and modify the F matrix
	...
	//define the acceleration noise components
	float noise_ax = 9;
	float noise_ay = 9;

	//set the process covariance matrix Q2, 0, 0, 2;
